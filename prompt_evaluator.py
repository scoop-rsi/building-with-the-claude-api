...
from requests import MessageBroker
...
class PromptEvaluator:
    ...
    def render(self, template_string, variables) -> str:
    ...
    def generate_unique_ideas(self, task_description, prompt_inputs_spec, num_cases):
        ...
        broker = MessageBroker(MODEL, MAX_TOKENS, system_prompt)
        text = broker.chat(rendered_prompt, 'json')
    ...
    def generate_test_case(self, task_description, idea, prompt_inputs_spec=None):
        ...
        prompt_inputs_spec = {} if prompt_inputs_spec == None else prompt_inputs_spec
    ...
    def grade_output(self, test_case, output, extra_criteria):
        ...
        * The full 1-10 scale should be utilized - don't hesitate to give low scores when warranted
        ...
        broker = MessageBroker(MODEL, MAX_TOKENS)
